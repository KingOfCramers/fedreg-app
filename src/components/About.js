...
const About = () => (
  <div className="box-layout">
    <div className="box-layout__box--about">
      ...
      <p>Users are emailed a zip file of PDFS (at their gmail address) at 9:00 a.m. Eastern Standard Time.</p>
      ...
      <p>By default, users will recieve all filings for the departments they are tracking. To only recieve rules or proposed rules, turn off the "all filings" setting for the department. To only recieve </p>
