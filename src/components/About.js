...
const About = () => (
  <div className="box-layout__about">
    <div className="box-layout__box--about">
      <p className="mission-statement">This tool was created to help journalists stay up-to-date on filings in the federal register.</p>
      <p>Users are emailed a compressed repository of PDFs (at their gmail address) at 9:00 a.m. Eastern Standard Time.</p>
      <p>The PDFs are downloaded from the federal register's <a href="https://www.federalregister.gov/public-inspection/current" target="blank">public inspection</a> repository. Rules, notices, and other documents are filed under public inspection before their formal publication in the federal register. It is earliest point of access for the public.</p>
